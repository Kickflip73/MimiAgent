...
- **M1.1 只剩 24h 日历 soak**：正式实机已累计 129/129 成功，四类能力均有分层样本，
  S0/S1=0；不再受旧 active Event 校准阻塞。进程诊断修复改变了最终运行时构建，
  因此只读窗口从 `2026-07-28T08:19:57.061Z` 重新起算，最早在
  `2026-07-29T08:19:57.061Z` 后验收。
