...
- **M1.1 只剩最新集成构建的 24h 日历 soak**：历史正式实机已累计 129/129 成功；
  当前最终构建 `0.12.0+b8fc2ecaea9e` 的首轮正式 canary 又完成 20/20，
  Browser/Computer/Screen/Shortcuts 各 5/5，blocked/failed/uncertain=0，
  S0/S1/S2/S3=0。只读窗口从 run
  `6513dc2c-3e64-4453-acba-46badda10f71` 完成时间
  `2026-07-28T10:18:52.062Z` 重新起算，最早在
  `2026-07-29T10:18:52.062Z` 后验收。heartbeat `m1-24h` 已更新为每 4 小时在
  当前主工作区追加同构建正式样本；日历时间不可伪造或压缩。
